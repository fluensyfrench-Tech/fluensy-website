...
function FooterUp() {
  ...
  return (
     <section className="bg-[#7148E5] text-white py-16  px-4 sm:px-6 lg:px-8" id="#waitlist">
        <motion.div
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold leading-tight md:leading-snug mb-4">
