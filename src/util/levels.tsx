...
export const levels = [
  ...
  },
  {
    ...
    priceUSD: "$140",
    level: "Elementary (A2)",
    requirement: "A1 level or equivalent required",
    description: "Expand your French skills",
    outcomes: [
  ...
  },
  {
    ...
    requirement: "A2 level or equivalent required",
  ...
  },
  {
    ...
    requirement: "B1 level or equivalent required",
    description: "Communicate fluently",
    outcomes: [
