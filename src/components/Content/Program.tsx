...
//       fetchCohorts();
//     }
//   }, [fetchCohorts, mounted]);

//   // ✅ Modal handler
//   const handleOpenModal = useCallback((cohortId: string, course: Course) => {
...
//   // ✅ Modal handler with currency
//   const handleOpenModal = useCallback((cohortId: string, course: Course, currency: "NGN" | "USD") => {
//     setSelectedCourse(course);
//     setSelectedCohortId(cohortId);
...
//                               <li
//                                 className="px-4 py-3 hover:bg-[#F3F0FF] cursor-pointer text-sm"
//                                 onClick={() => handleOpenModal(cohort.id, course, "NGN")}
//                               >
//                                 Pay in ₦ Naira
//                               </li>
//                               <li
//                                 className="px-4 py-3 hover:bg-[#F3F0FF] cursor-pointer text-sm border-t border-gray-100"
...
const Program = () => {
  ...
  // ✅ Modal handler
  const handleOpenModal = (cohortId: string, course: Course, currency: "NGN" | "USD") => {
    setSelectedCourse(course);
    setSelectedCohortId(cohortId);
    setSelectedCurrency(currency);
    setShowModal(true);
                          ...
                          {openDropdown === course.id && (
                            <ul className="absolute z-10 mt-2 w-full bg-white border border-[#C7CAD1] rounded-lg shadow-md overflow-hidden">
                              ...
                              <li
                                ...
                                onClick={() => {
                                  if (paymentOptions?.currencies?.USD?.available) {
