...
export const CourseDetails = () => {
    ...
    const renderCourseDetails = () => {
        if (courseType == 'adults') return (
            <div>
                <div>
                    <h1 className="text-[35px] font-medium text-primary">Single-level course <span>(January cohort)</span></h1>
                    <div className="bg-secondary-2 rounded-lg px-4 py-9 mt-5">
                        ...
                        <div className="mt-[30px] flex flex-col md:flex-row gap-4">
                            {singleLevelCourseInfo.map(course => (
                                <div key={course.id} className="rounded-lg bg-white px-5 py-6 flex flex-col flex-1">
                                    <div className="child:bg-secondary-3 child:text-[18px] child:font-medium child:text-white child:px-[10px] child:py-[5px] child:rounded-lg space-x-[10px]">
                                        ...
                                        <span>{course?.pricing[1]}</span>
                                    </div>
                                    <h2 className="text-primary font-bold text-[20px] mt-[18px]">{course?.title}</h2>
                                    <p className="text-sm text-grey-600 mt-1">{course.subtitle}</p>
                                    <h3 className="text-[16px] font-medium text-primary mt-[20px]">{course?.heading}</h3>
                                    <p className="text-grey-600 mt-2 flex-1">{course?.description}</p>
                                    <div className="relative mt-5 pt-4">
                                        ...
                                        >
                                            Register Now <ChevronDown className="w-3 h-3 md:w-4 md:h-4" />
                                        </button>
                                        ...
                                        {openDropdown === course.id && (
                                            <ul className="absolute z-10 mt-2 w-full bg-white rounded-lg shadow-md overflow-hidden">
                                                <li
                                                    ...
                                                    onClick={() => console.log("Pay in NGN for course:", course.id)}
                                                >
                                                    Naira
                                                </li>
                                                <li
                ...
                <h1 className="text-[35px] font-medium text-primary mt-[67px]">Beginner to intermediate <span>(November cohort)</span></h1>
                    ...
                    <div className="mt-[30px] flex gap-4 flex-1 bg">
                        {
                            ...
                            "
                                    ...
                                    <h2 className="text-primary font-bold text-[20px] mt-[18px]">Beginner (A1)</h2>
        ...
        if (courseType == 'kids') return (
            <div>
                <h1 className="text-[35px] font-medium text-primary">Beginner french for kids <span>(January cohort)</span></h1>
                <div className="bg-secondary-2 rounded-lg px-4 py-8 md:py-0 md:pb-8 mt-5 flex flex-col md:flex-row items-center">
                    <ul className="space-y-6 flex-1">
                        {
