...
const Content: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 !mt-10 sm:px-6 lg:px-8 py-8 md:py-12">
        <motion.div
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          className="rounded-2xl mx-auto overflow-hidden max-w-[1080px] !mt-12 md:!mt-20 shadow-lg"
        >
          <div className="flex flex-col md:flex-row">
            <div className="w-full bg-[#0f1724] p-6 sm:p-8 md:p-10 text-white">
            ...
            <div className="w-full bg-[#7DE5F2] p-6 sm:p-8 md:p-10 text-[#0f1724]">
              <ul className="space-y-3 md:space-y-4">
                {message.map((text, idx) => (
                  <li key={idx} className="flex items-start gap-2 md:gap-3">
                    <span className="flex items-center justify-center bg-white rounded-full w-5 h-5 md:w-6 md:h-6 text-[#7DE5F2] flex-shrink-0 mt-0.5">
                      <svg
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-14">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          >
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal md:font-medium leading-tight md:leading-snug mb-6">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="flex flex-col-reverse md:flex-row justify-between gap-8 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: true, amount: 0.2 }}
            className=" lg:order-1 flex flex-col justify-center items-center lg:items-start w-full max-w-[379px] mx-auto"
          >
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center font-medium mb-6">
      ...
      <section className="max-w-7xl m-0 sm:mx-auto px-0 sm:px-6 lg:px-8 py-8 md:py-10 lg:py-14">
        ...
        >
          ...
          <div className="text-white flex flex-col justify-center w-full md:w-2/3 p-0 md:p-4">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-medium leading-tight md:leading-snug mb-3">
      ...
      <section className="py-12 md:py-20 relative overflow-hidden mb-7 md:mb-20 px-4">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-light leading mb-3">
            Get ready to be fluent
          </h1>
          <p className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-bold mb-6">
            It&apos;s possible
          </p>
          <Link href="/program">
            <MotionButton>Start learning now</MotionButton>
